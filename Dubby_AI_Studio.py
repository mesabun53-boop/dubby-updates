...
# Set False to disable silent startup checks; users can still use Update → Check for Updates.
...
class DubbyAIStudio(QMainWindow):
    ...
    def _build_file_menu(self):
        ...
        update_menu.addAction(act_about)
    ...
    def _show_about(self):
        QMessageBox.about(
            ...
            "Use <b>Update → Check for Updates</b> when the manager releases new features."
        )
